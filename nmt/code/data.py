...
class Corpus:
    def __init__(self, sourceTrainFile='', sourceOrigTrainFile='', targetTrainFile='', sourceDevFile='', sourceOrigDevFile='', targetDevFile='',
                 squadContextSourceFile='', squadQuestionSourceFile='', minFreqSource=1, minFreqTarget=1, maxTokenLen=100000):
        ...
        self.squadContextData = self.buildDataset(
            squadContextSourceFile, squadContextSourceFile, squadContextSourceFile, train=False)
        self.squadQuestionData = self.buildDataset(
            squadQuestionSourceFile, squadQuestionSourceFile, squadQuestionSourceFile, train=False)
    ...
    def processBatchInfoNMT(self, batch, train, volatile=False):
        ...
        batchInputTarget = Variable(
            batchInputTarget, requires_grad=False, volatile=volatile)
        batchTarget = Variable(
            batchTarget, requires_grad=False, volatile=volatile)
